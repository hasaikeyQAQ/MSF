...
class MyCoTransform(object):
    ...
    def __call__(self, inputs_list, thermals_list, labels_list):
        ...
        if self.augment and self.random_crop:
            ...
            if if_crop < 0.5:
                randcrop_x = random.randint(0, inputs_list[0].size[0] - int(inputs_list[0].size[0]*0.8))
                randcrop_y = random.randint(0, inputs_list[0].size[1] - int(inputs_list[0].size[1]*0.8))
