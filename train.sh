...
CUDA_VISIBLE_DEVICES=0 python main.py --backbone deeplab50 --weights save/training_base_deeplab/model_base.pth --training --gpus 1 --lr-start 2e-4 --lr-strategy plateau_08 --num-epochs 20 --batch-size 2 --stm-queue-size 3 --sample-rate 3 --savedir save/training_msa_deeplab
